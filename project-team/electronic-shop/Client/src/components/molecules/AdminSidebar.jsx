...
const links = [
  ...
  { path: '/admin/orders', label: 'Đơn hàng', icon: PackageSearch, allowedRoles: ['ADMIN', 'STAFF'] },
  { path: '/admin/users', label: 'Người dùng', icon: Users, allowedRoles: ['ADMIN'] },
  { path: '/admin/support', label: 'Yêu cầu hỗ trợ', icon: Headset, allowedRoles: ['ADMIN', 'STAFF'] },
  { path: '/admin/chat', label: 'Trò chuyện trực tuyến', icon: MessageSquareText, allowedRoles: ['ADMIN', 'STAFF'] },
]
